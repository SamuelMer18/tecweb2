                ...
                <form action="modificar.php" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select" name="Categoria">
                            <?php
                            while ($nombre = mysqli_fetch_array($r2)) {
                                if ($data['categoria'] == $nombre['nombre_c']) {
                                    echo "<option value='$nombre[id]' selected>$nombre[nombre_c]</option>";
                                } else {
                                    echo "<option value='$nombre[id]'>$nombre[nombre_c]</option>";
                                }
                            }
                            ?>
                        </select>
